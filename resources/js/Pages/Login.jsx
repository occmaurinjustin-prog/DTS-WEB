    ...
    return (
        <>
            ...
            <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-900">
                ...
                <Link 
                    href="/"
                    className="absolute top-6 left-6 md:top-8 md:left-8 z-20 flex items-center gap-2 text-white/80 hover:text-white bg-black/20 hover:bg-black/40 backdrop-blur-md px-4 py-2 rounded-full transition-all duration-300 shadow-lg"
                >
                ...
                <div className={`relative z-10 w-full max-w-4xl mx-4 transition-all duration-700 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
                    ...
                    <div 
                        className={`relative p-[3px] rounded-[20px] bg-gradient-to-br from-emerald-600 via-emerald-500 to-teal-700 shadow-[0_20px_60px_rgba(0,0,0,0.4)] hover:shadow-[0_25px_70px_rgba(0,0,0,0.5)] transition-all duration-500 hover:-translate-y-1 ${isLoaded ? 'animate-fade-up' : ''}`}
                        style={{
                            background: 'linear-gradient(135deg, #10b981 0%, #059669 25%, #047857 50%, #059669 75%, #10b981 100%)',
                            ...
                            <form className="space-y-4" onSubmit={submit}>
                                ...
                                <div className={`pt-2 ${isLoaded ? 'animate-fade-up delay-600' : ''}`}>
                                    <button
                                        type="submit"
                                        disabled={processing}
                                        className="group relative w-full flex justify-center py-3 px-4 text-sm font-semibold text-white bg-slate-900 hover:bg-slate-950 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 disabled:opacity-70 disabled:cursor-not-allowed transition-all duration-200 hover:shadow-lg hover:shadow-emerald-500/10 hover:-translate-y-0.5 active:translate-y-0"
                                    >
                                        {/* Shimmer Effect */}

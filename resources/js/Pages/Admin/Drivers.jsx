        ...
        <AdminLayout title="Driver Management" authUser={authUser} activeMenu="drivers" pendingDeliveries={stats?.pending_deliveries || 0}>
            <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <button onClick={handleAddDriver} className="inline-flex items-center gap-1.5 px-4 py-2 bg-[#4F46E5] hover:bg-[#4338CA] text-white text-sm font-medium rounded-lg shadow-md shadow-indigo-500/20 hover:shadow-lg transition-all">

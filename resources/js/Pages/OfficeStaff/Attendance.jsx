        ...
        <OfficeStaffLayout activeMenu="attendance" title="Attendance Management">
            ...
            <div className="max-w-7xl pb-12">
                <div className="flex justify-end gap-3 mb-6">
                    <button className="px-4 py-2 bg-white border border-zinc-200 text-zinc-700 hover:bg-zinc-50 hover:text-zinc-900 transition-colors flex items-center gap-2 font-medium text-sm">
                        <Download className="w-4 h-4 text-zinc-500" /> Export PDF
                    </button>
                    <button className="px-4 py-2 bg-white border border-zinc-200 text-zinc-700 hover:bg-zinc-50 hover:text-zinc-900 transition-colors flex items-center gap-2 font-medium text-sm">
                        <FileSpreadsheet className="w-4 h-4 text-zinc-500" /> Export Excel
                    </button>
                </div>

                <div className="bg-white border border-zinc-200 mb-6 p-6">
                    <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4 items-end">
                        ...
                        <div className="flex gap-3 w-full md:w-auto mt-4 md:mt-0">
                            <button type="submit" className="flex-1 md:flex-none px-6 py-2 bg-zinc-900 text-white hover:bg-zinc-800 transition-colors flex items-center justify-center gap-2 font-medium text-sm">
                                <Search className="w-4 h-4" /> Filter
                            </button>
                            <button type="button" onClick={clearFilters} className="px-4 py-2 text-zinc-500 border border-zinc-200 bg-zinc-50 hover:bg-zinc-100 transition-colors flex items-center justify-center gap-2 font-medium text-sm">
